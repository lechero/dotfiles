...
return {
	...
	config = function()
		...
		cmp.setup({
			...
			-- show the docs preview with a border
			window = {
				documentation = cmp.config.window.bordered(), --  [oai_citation:2‡GitHub](https://github.com/hrsh7th/nvim-cmp/issues/1029?utm_source=chatgpt.com)
			},
		...
		-- optionally also enable border in command-line mode
		cmp.setup.cmdline("/", {
